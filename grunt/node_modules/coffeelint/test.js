...
module.exports = ASTLinter = (function(_super) {
  ...
  function ASTLinter(source, config, rules, _at_CoffeeScript) {
    this.CoffeeScript = _at_CoffeeScript;
...
module.exports = BaseLinter = (function() {
  function BaseLinter(_at_source, _at_config, rules) {
    this.source = _at_source;
    this.config = _at_config;
...
TokenApi = (function() {
  function TokenApi(CoffeeScript, source, _at_config, _at_tokensByLine) {
    this.config = _at_config;
    this.tokensByLine = _at_tokensByLine;
...
LineApi = (function() {
  function LineApi(source, _at_config, _at_tokensByLine, _at_literate) {
    this.config = _at_config;
    this.tokensByLine = _at_tokensByLine;
    this.literate = _at_literate;
    this.line = null;
    this.lines = source.split('\n');
...
module.exports = NoTabs = (function() {
  ...
  NoTabs.prototype.lintAST = function(node, _at_astApi) {
    this.astApi = _at_astApi;
    this.lintNode(node);
    return void 0;
  };
...
module.exports = MissingFatArrows = (function() {
  ...
  MissingFatArrows.prototype.lintAST = function(node, _at_astApi) {
    this.astApi = _at_astApi;
    this.lintNode(node);
    return void 0;
  };
...
module.exports = NoUnnecessaryFatArrows = (function() {
  ...
  NoUnnecessaryFatArrows.prototype.lintAST = function(node, _at_astApi) {
    this.astApi = _at_astApi;
    this.lintNode(node);
    return void 0;
  };
...
},{"./empty_constructor_needs_parens.coffee":14}],37:[function(require,module,exports){
var RuleProcessor;
